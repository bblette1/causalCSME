...
\begin{table}[h]
\tblcaption{Simulation study for case-cohort design with larger effective sample size}
{\tabcolsep=6.25pt
...
\begin{table}[h]
\tblcaption{Simulation study for case-cohort design with smaller effective sample size}
{\tabcolsep=6.25pt
\begin{tabular}{@{}lcrrrr@{}}
\tblhead{Estimator & Correct Specifications & Bias & ASE & ESE & Coverage}
