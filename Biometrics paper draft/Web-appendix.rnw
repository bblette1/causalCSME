...
The structure of the second simulation study described in Section 5 of the paper is replicated, but under a two-phase sampling design. In particular, blank.
